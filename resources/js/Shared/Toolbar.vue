  ...
  <div id="nav" class="bg-white shadow">
    ...
    >
        ...
        <div class="relative z-10 bg-white">
            ...
            <a href="#" class="mt-8 block text-xs font-semibold text-gray-600 uppercase tracking-wider">Projects</a>
            <a href="#" class="mt-4 block font-medium text-gray-900 hover:text-gray-700">Browse</a>
            <a href="#" class="mt-4 block font-medium text-gray-900 hover:text-gray-700">Create</a>
            <a href="#" class="mt-4 block font-medium text-gray-900 hover:text-gray-700">Import</a>
            </div>
            <div class="border-t-2 border-gray-200 px-4 pt-6">
            <a href="#" class="block font-medium text-gray-900 hover:text-gray-700">About</a>
            <a href="#" class="mt-4 block font-medium text-gray-900 hover:text-gray-700">Contribute</a>
            <a href="#" class="mt-4 block font-medium text-gray-900 hover:text-gray-700">Repository</a>
            </div>
        </div>
        <div class="relative bg-white">
            <div class="p-4">
            <a href="#" class="block px-3 py-3 font-medium text-center bg-gray-300 rounded-lg text-gray-900 hover:bg-gray-400 focus:outline-none focus:bg-gray-400">Documentation</a>
            </div>
        </div>
        </div>
    </transition>
